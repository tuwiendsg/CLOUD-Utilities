...
public class ComotMessagingFactory {
	...
	public static RabbitMqConsumer getRabbitMqConsumer(DiscoverySettings settings) {
		return getRabbitMqConsumer(getServiceDiscovery(settings));
	}
	...
	public static RabbitMqProducer getRabbitMqProducer(DiscoverySettings settings) {
		return getRabbitMqProducer(getServiceDiscovery(settings));
	}
